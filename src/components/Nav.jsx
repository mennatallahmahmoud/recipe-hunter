    ...
    <nav className="bg-[#fbfbfb] shadow-md fixed w-full z-20 top-0 start-0 border-b border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:justify-center lg:justify-between mx-auto px-4">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse lg:hidden">
                <button data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:text-red-600" aria-controls="navbar-sticky" aria-expanded="false">
            ...
            <div className="items-center justify-between hidden w-full md:flex md:mx-auto lg:mx-0 md:w-auto md:order-1" id="navbar-sticky">
